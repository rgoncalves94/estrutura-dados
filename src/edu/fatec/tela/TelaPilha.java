...
import edu.fatec.pilha.PilhaAlunos;

public class TelaPilha {

	public static void main(String[] args) {
		PilhaAlunos fila = new PilhaAlunos(30);
		...
		while (opcao != 0) {
			...
			sb.append("1) Adicionar um aluno na pilha;\n");
			sb.append("2) Adicionar remover um aluno da pilha;\n");
